        ...
        <div className=" min-h-screen py-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-10">
                    ...
                    <p className="mt-2 text-lg">Empowering Knowledge, One Book at a Time</p>
                </div>

                <div className=" shadow-lg rounded-xl p-6 md:p-10">
                ...
                <div className="mt-10 text-center">
                    ...
                    <p className=" mt-2">A group of passionate individuals dedicated to enhancing your reading experience.</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-6">
                        ...
                        <div className=" shadow-lg rounded-xl p-6 text-center">
                            ...
                            <p className=" text-sm">Head Librarian</p>
                        </div>
                    </div>
                </div>
            </div>
