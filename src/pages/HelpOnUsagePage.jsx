  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">Welcome to the ShelfVista!</h2>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">1. Finding and Viewing All Books</h2>
        <p className="text-lg mb-4">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">2. Adding New Books</h2>
        <p className="text-lg mb-4">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">3. Updating Book Details</h2>
        <p className="text-lg mb-4">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">4. Borrowing Books</h2>
        <p className="text-lg mb-4">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold  mb-4">5. Returning Books</h2>
        <p className="text-lg  mb-4">
